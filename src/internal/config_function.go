...
func initialConfig(dir string) (toggleDotFileBool bool, toggleFooter bool, firstFilePanelDir string) {
	...
	if err != nil {
		...
		// This is not enough to make us exit !! This is fatal ?
	...
	// The fuck, ewwww. This rapes DRY principle.
	// Use a binary file reader/writer function with a default value.
	...
	if dir != "" {
		...
		// What is this shit ? Shouldn't you just do filepath.Abs when you read DefaultDirectory ?
	...
	slog.Debug("Runtime information", "runtime.GOOS", runtime.GOOS,
		...
		"Struct sizes, internal.Model" , reflect.TypeOf(model{}).Size(),
...
func loadConfigFile() {
	...
	// This is validation, should be a separate function.
