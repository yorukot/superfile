...
func getHelpMenuData() []helpMenuModalData {
	// The render for this would be so similiar to sidebar render. Its just
	// diabolical. So much duplication mess
	data := []helpMenuModalData{
		{
			subTitle: "General",
		},

		// Is this supposed to have that vague "|" ??
		// And is this supposed to be this fucking inconsistent
		// Both cant be yes for sure.
		// Having a blank just as a roundabout way of printing | at the end is just plain stupid.
		{
			hotkey:         []string{"spf", ""},
