...
// What the hell is going on here, this look like the slowest implementatin of zipping?
func zipSource(source, target string) error {
	...
	// For the sake of measuring progress, you cannot slow down the progress by 2x 
