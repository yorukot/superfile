...
If you suspect your `config.fish` file is located somewhere else, read https://fishshell.com/docs/current/language.html#configuration

Copy the following code into the file:

<CodeBlock file="cd_on_quit/cd_on_quit.fish" />

Save, exit, and reload `config.fish` file:
