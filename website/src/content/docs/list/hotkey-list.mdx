...
| Folder          | Default key | Setting              |
| --------------- | ----------- | -------------------- |
| Home            | `alt+h`     | `go_to_home`         |
| Downloads       | `alt+d`     | `go_to_downloads`    |
| Desktop         | `alt+e`     | `go_to_desktop`      |
| Documents       | `alt+o`     | `go_to_documents`    |
| Pictures        | `alt+p`     | `go_to_pictures`     |
| Music           | `alt+m`     | `go_to_music`        |
| Videos          | `alt+v`     | `go_to_videos`       |
| Templates       | `alt+t`     | `go_to_templates`    |
| PublicShare     | `alt+s`     | `go_to_public_share` |
| Trash (Linux)   | `alt+r`     | `go_to_trash`        |
| Pinned folder 1 | `alt+1`     | `go_to_pin_1`        |
| Pinned folder 2 | `alt+2`     | `go_to_pin_2`        |
| Pinned folder 3 | `alt+3`     | `go_to_pin_3`        |
| Pinned folder 4 | `alt+4`     | `go_to_pin_4`        |
| Pinned folder 5 | `alt+5`     | `go_to_pin_5`        |
| Pinned folder 6 | `alt+6`     | `go_to_pin_6`        |
| Pinned folder 7 | `alt+7`     | `go_to_pin_7`        |
| Pinned folder 8 | `alt+8`     | `go_to_pin_8`        |
| Pinned folder 9 | `alt+9`     | `go_to_pin_9`        |

These shortcuts open folders in the current file panel and focus it. They are inactive in prompts, searches, rename fields, and dialogs. Pin numbers follow the filtered sidebar order, independent of scrolling. Missing targets are ignored.
